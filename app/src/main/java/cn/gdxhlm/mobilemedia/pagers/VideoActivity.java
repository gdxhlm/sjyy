...
public class VideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myVideoView=findViewById(R.id.vv);
       ...
       // videoView.setVideoPath("http://devimages.apple.com.edgekey.net/streaming/examples/bipbop_4x3/gear2/prog_index.m3u8");
        myVideoView.setOnPreparedListener(new MyOnPreparedListener());
                ...
                public boolean onInfo(MediaPlayer mediaPlayer, int i, int i1) {
                    switch (i){
                        case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                            ...
                            Toast.makeText(VideoActivity.this, "卡顿开始了", Toast.LENGTH_SHORT).show();
                            break;
                        case MediaPlayer.MEDIA_INFO_BUFFERING_END:
                            Toast.makeText(VideoActivity.this, "卡顿结束", Toast.LENGTH_SHORT).show();
                             break;
                    }
    ...
    private Handler handler=new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what){
                case 1:
                    seekBar_sp.setProgress(myVideoView.getCurrentPosition());
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            ...
            seekBar_sp.setMax(myVideoView.getDuration());
